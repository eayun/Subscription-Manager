...
Patch0:	python-rhsm-1.9.7.patch
...
%changelog
* Fri May 16 2014 jesus m. rodriguez <jesusr@redhat.com> 1.9.7-1
- 1096734: json ValueErrors have no .msg attribute (alikins@redhat.com)
...
* Thu Sep 12 2013 jesus m. rodriguez <jesusr@redhat.com> 1.9.5-1
...
- remove obsolete releasers, keep rhel-6.5 (jesusr@redhat.com)
- 922837: rebase python-rhsm
